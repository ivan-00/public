...
function caisse_mobile_enqueue_assets(): void
{
    ...
    wp_enqueue_script(
        'caisse-mobile-historique',
        $theme_uri . '/assets/js/historique.js',
        ['caisse-mobile-storage', 'caisse-mobile-vente'],
        filemtime($theme_path . '/assets/js/historique.js'),
        true
    );
    ...
    wp_enqueue_script(
        ...
        ['caisse-mobile-vente', 'caisse-mobile-encaissement', 'caisse-mobile-recap', 'caisse-mobile-historique'],
